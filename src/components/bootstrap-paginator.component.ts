...
@Component({
    ...
    <sfPaginator #p [sfTable]="sfTable">
        <ul class="pagination" *ngIf="p.dataLength > p.rowsOnPage">
            ...
            <li class="page-item" *ngIf="p.currentPage > 4 && p.currentPage + 1 > p.lastPage" (click)="p.setPage(p.currentPage - 4)">
                <a class="page-link" style="cursor: pointer">{{p.currentPage-4}}</a>
            </li>
            <li class="page-item" *ngIf="p.currentPage > 3 && p.currentPage + 2 > p.lastPage" (click)="p.setPage(p.currentPage - 3)">
            ...
            <li class="page-item" *ngIf="p.currentPage + 3 <= p.lastPage && p.currentPage < 3" (click)="p.setPage(p.currentPage + 3)">
                <a class="page-link" style="cursor: pointer">{{p.currentPage+3}}</a>
            </li>
            <li class="page-item" *ngIf="p.currentPage + 4 <= p.lastPage && p.currentPage < 2" (click)="p.setPage(p.currentPage + 4)">
                <a class="page-link" style="cursor: pointer">{{p.currentPage+4}}</a>
            </li>
